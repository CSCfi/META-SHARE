...
# cPOUTA VALUE (VM IP)
#DJANGO_URL = 'http://195.148.30.210'
...
LOG_FILENAME = "/var/log/metashare/metashare.log"
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql_psycopg2', # Add 'postgresql_psycopg2', 'mysql',
                                         # 'sqlite3', 'oracle'.
        'NAME': 'metashare_db',                      # database name -- or path to file if
                                         # using sqlite3, e.g.
        ...
        'USER': 'metashare_user',                      # Not used with sqlite3.
        'PASSWORD': 'metashare_user_pwd',                  # Not used with sqlite3.
        'HOST': '10.130.6.9',                      # Set to 'localhost' for localhost.
...
#    'proxied_node_id_1': {
#        'NAME': 'Proxied Node 1',
#        'DESCRIPTION': 'xxx',UPGRADE_PIP_TO_LATEST
